...
- `C10` repaso acumulativo: grafica final de \(f(x)=x+\frac{4}{x}\) con asintotas y extremos.

## Resultado de la revision

- Los capitulos incluidos en `tex/main_student.tex` contienen `12` marcadores activos de figura
  (`tikzpicture` o `axis`).
...
- No se incorporan arboles de probabilidad ni diagramas de Venn porque ese bloque sigue sin
  corpus fuente en la carpeta actual.
